import type { AppTab } from "./runner";
...
/** Red/black top bar: brand, page tabs, and the GitHub source link. */
  ...
  return (
    <header className="topbar">
      <button
        ...
        aria-label="HMX — compiler playground"
      >
      ...
      <nav className="tabs" aria-label="Main">
        <button
          className={`tab ${tab === "playground" ? "tab-active" : ""}`}
          onClick={() => onNavigate("playground")}
        >
          Playground
        </button>
